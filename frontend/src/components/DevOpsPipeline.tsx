        ...
        <div className={`mt-12 p-6 rounded-2xl bg-card border border-primary/30 ${isVisible ? 'animate-fade-in-up' : 'opacity-0'}`}>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-3">
            {[
              ...
              { name: 'GitHub Webhook', url: window.location.hostname !== 'localhost' && window.location.hostname !== '127.0.0.1' ? `http://${window.location.hostname}/github-webhook/` : 'http://localhost/github-webhook/', desc: 'GitHub Webhook Receiver' },
