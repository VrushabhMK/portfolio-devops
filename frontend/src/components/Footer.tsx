...
const socialLinks = [
  ...
  { icon: Mail, href: 'mailto:arjun.sharma@example.com', label: 'Email' },
]
        ...
        <div className="grid sm:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground leading-relaxed">
              Full-Stack Developer & DevOps Engineer crafting scalable cloud-native applications
            ...
            <div className="flex gap-3">
              {socialLinks.map(({ icon: Icon, href, label }) => (
                <a
                  ...
                  className="p-2 rounded-lg border border-border hover:border-primary hover:text-primary transition-all duration-300 hover:scale-110"
                  aria-label={label}
                >
